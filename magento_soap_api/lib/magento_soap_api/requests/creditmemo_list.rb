module MagentoSoapApi::Requests
  class CreditmemoList
    ...
    def body
      merge_filters!(sales_creditmemo_list_hash)
    end
    ...
    def sales_creditmemo_list_hash
      {
        session_id: self.session_id
      }
    end

    def merge_filters!(sales_creditmemo_list_hash)
      if !filters_array.empty?
        sales_order_list_filters = {
          filters: filters_array,
        }
        sales_creditmemo_list_hash.merge!(sales_order_list_filters)
      else
        sales_creditmemo_list_hash
      end
    end
