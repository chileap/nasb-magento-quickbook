module Concerns::QuickbooksApiToken
  URL = 'https://oauth.intuit.com'.freeze

  def create_consumer(consumer_data)
    OAuth::Consumer.new(consumer_data[:consumer_key], consumer_data[:consumer_secret], site: URL, request_token_path: '/oauth/v1/get_request_token', authorize_url: 'https://appcenter.intuit.com/Connect/Begin', access_token_path: '/oauth/v1/get_access_token')
  end
